                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('inputs.expiry_date') }}</th>
                                    <th>{{ trans('inputs.city') }}</th>
                                    <th>{{ trans('inputs.investment_amount') }}</th>
                            ...
                            <tbody>
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item['user_profile']['birthday'] }}</td>
                                        <td>{{ $item['user_profile']['expiry_date'] }}</td>
                                        <td>{{ $item['user_profile']['city'] }}</td>
                                        <td>{{ $item['user_profile']['investment_amount'] }}</td>
                                        <td>{{ $item['user_profile']['id_number'] }}</td>
