...
@section('content')
    ...
    <div class="col-md-10">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-inline" action="{{ route('documents.case.index') }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('documents.case.add') }}" class="btn btn-success btn-sm">
                    <i class="glyphicon glyphicon-plus glyphicon-white"></i> 新增判决文书
                </a>
            </div>
        </div>
        <br />
                            ...
                            @if (!empty($items))
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('documents.case.edit', $item['_id']) }}" target="_blank">
                                                <button class="btn btn-sm btn-primary">
                                                    编辑
                                                </button>
                                            </a>
        ...
        @include('layouts.pagination', ['routeName'=>'documents.case.index', 'count'=>$itemsCount, 'page'=>$page_num, 'size' => $pageSize, 'filters' => $filters])
    </div>
@endsection
